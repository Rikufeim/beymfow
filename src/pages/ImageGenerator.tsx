      ...
      <SEOHead
        ...
        schemas={[
          ...
          buildBreadcrumbSchema([
            ...
            { name: "Image Generator", url: `${SITE_URL}/image-generator` },
          ]),
        ]}
      />
      <CreditsDisplay />
        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center">
          <div className="w-full flex flex-col items-center pt-[80px] pb-16 px-4">
            ...
            >
              ...
              <div className={`bg-black backdrop-blur-sm rounded-2xl p-8 border-2 mb-8 transition-all duration-500 relative ${isGenerating
                  ? 'border-gray-400'
