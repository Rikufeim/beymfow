...
export const PricingCarousel = () => {
  return <section className="px-4 sm:px-6 lg:px-8 py-24 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-24 items-center">
          ...
          delay: 0.2
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">Pricing plans  </h2>
