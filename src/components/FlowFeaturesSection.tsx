...
export const FlowFeaturesSection = ({
  ...
  return <section className={`py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 ${className}`}>
      ...
      <div className="w-full mx-auto space-y-16 md:space-y-24">
        {/* Flow Engine Section - Image Left, Text Right */}
        <motion.div initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        ...
        duration: 0.6
          ...
          <div className="relative min-h-[300px] md:min-h-[400px] overflow-hidden w-full h-full order-2 md:order-1 cursor-pointer" onClick={() => navigate("/flow-engine")}>
